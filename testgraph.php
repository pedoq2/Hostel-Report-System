...
include("fusioncharts.php");
    ...
    */
			 ...
			 $result=mysqli_query($con, 'select  * from glucose where patient_IC_No="940418045135"');
			 $result1=mysqli_query($con, 'select  * from glucose where patient_IC_No="940418045135"');
