...
$image_url='images/LogoJawi.png' ;
    ...
    if (isset($_REQUEST['username'])){
        ...
        {$query = "INSERT into `users` (username, password, email, trn_date , userdetection, matricno ,phone ,UserFullName) VALUES ('$username', '".md5($password)."', '$email', '$trn_date' , '1','$Matric','$Phone' , '$FullName')";
...
Matric No :<input type="text" name="MatricNo" placeholder="BXXXXXXXXXX" required /><br>
